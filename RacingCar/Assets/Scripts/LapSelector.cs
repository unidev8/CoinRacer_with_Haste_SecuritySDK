...
public class LapSelector : MonoBehaviour
{
    ...
    public static int nLaps = 2;//here we create a STATIC int to import it from the script LapsSelectedManager.cs
    ...
    private void Start()
    {
        nLaps = 2;// Convert.ToInt32(Laps.GetComponent<Text>().text);
