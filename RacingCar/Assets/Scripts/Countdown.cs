...
public class Countdown : MonoBehaviour
{
    ...
    IEnumerator CountStart()
    {
        ...
        if (GetReady != null) GetReady.Play();//play the ready noise (normal pitch bell)
        ...
        if (GetReady != null) GetReady.Play();
        ...
        if (GoAudio != null) GoAudio.Play();//play the go noise (high pitch bell)
        ...
        PlayerScore.cmdSetSync_hasStart (true);
