...
public class BotSelector : MonoBehaviour
{
    ...
    public static int nBots = 8;//here we create a STATIC int to import it from the script BotsSelectedManager.cs    
    private int ReactivatePlusButton;

    private void Start()
    {
        nBots = 8;//at the start of the game, the number of selected bots is 1
