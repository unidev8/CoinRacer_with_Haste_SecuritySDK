...
public class Mobile_Left : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Start()
    {
        ...
        cEvent.AddListener(delegate { playerObj.GetComponent<CarUserControl>().Horizontal_N(); });
