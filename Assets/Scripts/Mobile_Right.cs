...
public class Mobile_Right : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Start()
    {
        ...
        cEvent.AddListener(delegate { playerObj.GetComponent<CarUserControl>().Horizontal_P(); });
