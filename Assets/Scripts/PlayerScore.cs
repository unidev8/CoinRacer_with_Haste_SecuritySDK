...
namespace Mirror.Examples.MultipleAdditiveScenes
{
    public class PlayerScore : NetworkBehaviour
    {
        ...
        private bool clientHasEnd = false;
        ...
        private void Start()
        {
            ...
            UIManagerObj = GameObject.FindWithTag("UIManager").GetComponent<UIMananger>();//UIMananger.Instance; //
            hasEnded = false;
            hasStarted = false;
            clientHasEnd = false;
        ...
        void Update() // 
        {
            ...
            if (timeRemaining > 0)
            {
                timeRemaining = countTime - (int)(NetworkTime.time - startTime);//Time.deltaTime; 
