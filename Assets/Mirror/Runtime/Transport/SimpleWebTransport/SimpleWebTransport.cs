...
namespace Mirror.SimpleWeb
{
    ...
    public class SimpleWebTransport : Transport
    {
        ...
        public override void ClientConnect(string hostname)
        {
            ...
            //Debug.Log("SimpleWebTransport.ClinetConnect: is started! hostname:" + hostname);
            ...
            //Debug.Log("SimpleWebTransport.ClinetConnect: is ended!");
        }
        ...
        {
            //Debug.Log("SimpleWebTransport.ServerStart: is started");
            ...
            Debug.Log("SimpleWebTransports.ServerStart: config.sslProtocols=" + config.sslProtocols + ", TcpConfig.receiveTimeout=" + TcpConfig.receiveTimeout );
            ...
            //Debug.Log("SimpleWebTransports.ServerStart: server.GetType=" + server.GetType() + ", server.Hashcode=" + server.GetHashCode());

            server.Start(port);

            //Debug.Log("SimpleWebTransport.ServerStart: is ended!");
        }
