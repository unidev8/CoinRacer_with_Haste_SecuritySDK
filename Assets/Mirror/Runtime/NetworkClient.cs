...
namespace Mirror
{
    ...
    public static class NetworkClient
    {
        ...
        {
            //Debug.Log("NetworkClient.AddTransportHandlers: is started!");
            ...
            //Debug.Log("NetworkClient.AddTransportHandlers: is ended!");
        }

        internal static void RegisterSystemHandlers(bool hostMode)
        {
            //Debug.Log("NetworkClient.RegisterSystemHanders: is started!");
           ...
           // Debug.Log("NetworkClient.RegisterSystemHanders: is ended!");
        }
        ...
        {
            Debug.Log($"NetworkClient.Connect: Client is starting to Connect at {address}");
            ...
            //if (address != "localhost")
                //address = address.Substring(8); // in case https://
            Debug.Log("SimpleWebTransport.ClientConnect: hostname=" + address);

            Transport.activeTransport.ClientConnect(address);

            connection = new NetworkConnectionToServer();
            Debug.Log("NetworkClient.Connect: new connection = " + connection.ToString() + "is established!");
        }

        /// <summary>Connect client to a NetworkServer by Uri.</summary>
        public static void Connect(Uri uri)
        {
            //Debug.Log($"NetworkClient.connect(uri): Client is starting to Connect at {uri}");
            Debug.Assert(Transport.activeTransport != null, "There was no active transport when calling NetworkClient.Connect, If you are calling Connect manually then make sure to set 'Transport.activeTransport' first");
            ...
            connection = new NetworkConnectionToServer();
            Debug.Log("NetworkClient.Connect(uri): new connection = " + connection.ToString() + "is established!");
        }
