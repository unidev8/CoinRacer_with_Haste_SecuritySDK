...
public class HasteRequestBase
{
    ...
    where T : HasteError
    {
        ...
        Debug.Log("ProcessRequest: uri =" + uri + ", webRequest.result =" + webRequest.result + ", webRequest.error =" + webRequest.error );
