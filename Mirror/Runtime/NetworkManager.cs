...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        void SetupServer()
        {
            //Debug.Log("NetworkManager.SetupServer: is started!");
            ...
            //Debug.Log("NetworkManager.SetupServer: Networksever is Listening!");
        ...
        {
            //Debug.Log("NetworkManager.StartServer: is started!");
        ...
        public void StartClient()
        {
            ...
            Debug.Log($"NetworkManager.StartClient: Server address={networkAddress}, NetworkClient is connecting!" );
        ...
        public virtual void ServerChangeScene(string newSceneName)
        {
            ...
            Debug.Log($"NetworkManager.ServerChangeScene: {newSceneName} will be changed!");
