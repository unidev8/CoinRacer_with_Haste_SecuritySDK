...
namespace Mirror
{
    ...
    public static class NetworkServer
    {
        ...
        {
            //Debug.Log("NetworkServer.Initialze: is started!");
            ...
            //Debug.Log("NetworkServer.Initialze: is ended!");
        }
        ...
        {
            //Debug.Log("NetworkServer.Listen: is started!");
            ...
            //Debug.Log("NetworkServer.Listen: is ended!");
        }
        ...
        static void SpawnObject(GameObject obj, NetworkConnection ownerConnection)
        {
            ...
            //Debug.Log("NetworkServer.SpawnObject: GameObject=" + obj + ", ownerConnection=" + ownerConnection + " is spawned!");
        }
        ...
        {
            //Debug.Log("NetworkServer.Spawn: GameObject=" + obj + ", ownerConnection=" + ownerConnection + " will be spawned!");
        ...
        {
            //Debug.Log("NetworkServer.SpawnObject: is started!");
            ...
            //Debug.Log("NetworkServer.SpawnObject: is spawned!");
            return true;
        }
