...
namespace Mirror.SimpleWeb
{
    public class SimpleWebServer
    {
        ...
        {
            Debug.Log("SimpleWebServer.SimpleWebServer: is stated!");
            ...
            Debug.Log("SimpleWebServer.SimpleWebServer: is ended!");
        }
        ...
        {
            Debug.Log("SimpleWebServer.Start: is started!  server=" + server.GetType());

            server.Listen(port);
            Active = true;
            Debug.Log("SimpleWebServer.Start: is ended!");
        }
