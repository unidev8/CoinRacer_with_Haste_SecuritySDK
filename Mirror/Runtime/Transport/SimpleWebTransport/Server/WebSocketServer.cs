...
namespace Mirror.SimpleWeb
{
    public class WebSocketServer
    {
        ...
        {
            Debug.WriteLine("WebSocketServer.WevSocketServer: is started!");
            ...
            Debug.WriteLine("WebSocketServer.WevSocketServer: is ended!");
        }

        public void Listen(int port)
        {

            Debug.WriteLine("WebSocketServer.Listen: is started!: port=" + port);
           
            listener = TcpListener.Create(port); // for some reson in webgl this fuction is not executed!
            listener.Start();
            ...
            Debug.WriteLine("WebSocketServer.Listen: is ended!");
        }
