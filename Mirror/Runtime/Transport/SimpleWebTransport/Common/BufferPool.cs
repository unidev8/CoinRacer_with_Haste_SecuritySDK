...
namespace Mirror.SimpleWeb
{
    ...
    public class BufferPool
    {
        ...
        {
            Debug.Write ("BufferPool.BufferPool: is started!");
            ...
            Debug.Write("BufferPool.BufferPool: is ended!");
        ...
        void Validate()
        {
            Debug.Write("BufferPool.Validate: is started!");
            ...
            Debug.Write("BufferPool.Validate: is ended!");
        }
